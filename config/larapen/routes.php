...
if (config('settings.seo.multi_countries_urls')) {
    ...
    $routesTab['i-search-subCat'] = ':countryCode/job-influencers-category/:catSlug/:subCatSlug';
     $routesTab['v-search-subCat'] = ':countryCode/job-category/:catSlug/:subCatSlug';
     $routesTab['e-search-subCat'] = ':countryCode/influencers-category/:catSlug/:subCatSlug';

    // Search by Category
    $routesTab['search-cat'] = '{countryCode}/job-category/{catSlug}';
     $routesTab['job-influencers-category'] = '{countryCode}/job-influencers-category/{catSlug}';
    $routesTab['t-search-cat'] = 'job-category';
    $routesTab['v-search-cat'] = ':countryCode/job-category/:catSlug';
    $routesTab['e-search-cat'] = ':countryCode/influencers-category/:catSlug';
    $routesTab['i-search-cat'] = ':countryCode/job-influencers-category/:catSlug';
    // Search by Location
    ...
    $routesTab['v-search-subCat'] = 'job-category/:catSlug/:subCatSlug';
     $routesTab['e-search-subCat'] = 'influencers-category/:catSlug/:subCatSlug';

    // Search by Category
    $routesTab['search-cat'] = 'job-category/{catSlug}';
    $routesTab['influencers-cat'] = 'influencers-category/{catSlug}';
     $routesTab['i-search-cat'] = 'job-influencers-category/:catSlug';
      $routesTab['i-search-subCat'] = 'job-influencers-category/:catSlug/:subCatSlug';
    $routesTab['t-search-cat'] = 'job-category';
    $routesTab['v-search-cat'] = 'job-category/:catSlug';
    $routesTab['e-search-cat'] = 'influencers-category/:catSlug';
