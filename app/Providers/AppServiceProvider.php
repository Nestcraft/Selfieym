...
class AppServiceProvider extends ServiceProvider
{
	...
	private function setConfigVars()
	{
		...
		// instagram
		config()->set('services.instagram.client_id','728276848367720');
		config()->set('services.instagram.client_secret', env('FACEBOOK_CLIENT_SECRET', config('settings.social_auth.instagram_client_secret')));
		// LinkedIn
