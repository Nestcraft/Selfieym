...
use App\Models\Scopes\ActivePackageScope;
use App\Models\Traits\TranslatedTrait;
use App\Observer\PackageObserver;
use Larapen\Admin\app\Models\Crud;

class Packageinfluencer extends BaseModel
{
     ...
     * @var string
     */
    protected $table = 'packages_influencer';
    ...
    */
    protected static function boot()
    {
        ...
        static::addGlobalScope(new ActivePackageScope());
    }
