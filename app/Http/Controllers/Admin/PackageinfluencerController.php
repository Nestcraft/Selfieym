...
class PackageinfluencerController extends PanelController
{
	public function setup()
	{
		...
		|--------------------------------------------------------------------------
		*/
		$this->xPanel->setModel('App\Models\Packageinfluencer');
		$this->xPanel->setRoute(admin_uri('packages_influencer'));
		$this->xPanel->setEntityNameStrings(trans('Influencer Packages'), trans('Influencer Packages'));
		...
		*/
		...
		$this->xPanel->addField([
			'label'             => trans("admin::messages.Commission Type"),
		...
		$this->xPanel->addField([
			'name'              => 'commission',
			'label'             => trans('admin::messages.Commission'),
			'type'              => 'text',
			'attributes'        => [
				'placeholder' => trans('admin::messages.Commission'),
			],
			'wrapperAttributes' => [
				'class' => 'form-group col-md-6',
			],
