...
class ConversationController extends FrontController
{
	...
	public function checkNotification(Request $request)
	{
		...
		->where('notifications.notification_to_user_id', auth()->user()->id)
		->where('notifications.notification_is_read', 0)
		->select('*')
		->get();

		$total_notification = count($count_notification);

		$countLimit = 20;
		$countConversationsWithNewMessages = $total_notification;
		$oldValue = 0;
