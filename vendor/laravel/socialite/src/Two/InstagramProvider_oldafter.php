...
class InstagramProvider extends AbstractProvider implements ProviderInterface
{
    ...
    {
        return $this->buildAuthUrlFromBase('https://www.instagram.com/oauth/v2/authorization', $state);
    }
    ...
    {
        return 'https://www.instagram.com/oauth/v2/accessToken';
    }
    ...
    {
        $url = 'https://api.instagram.com/v2/me?projection=(id,firstName,lastName,profilePicture(displayImage~:playableStreams))';
    ...
    {
        $url = 'https://api.instagram.com/v2/emailAddress?q=members&projection=(elements*(handle~))';
    ...
    protected function mapUserToObject(array $user)
    {
        ...
        $avatar = Arr::first($images, function ($image) {
            return $image['data']['com.instagram.digitalmedia.mediaartifact.StillImage']['storageSize']['width'] === 100;
        });
        $originalAvatar = Arr::first($images, function ($image) {
            return $image['data']['com.instagram.digitalmedia.mediaartifact.StillImage']['storageSize']['width'] === 800;
        });
