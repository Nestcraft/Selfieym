...
//use Laravel\Socialite\One\InstagramProvider;
...
//use League\OAuth1\Client\Server\Instagram as InstagramServer;
...
class SocialiteManager extends Manager implements Contracts\Factory
{
    ...
    protected function createInstagramDriver()
    {
     ...
     /*protected function createInstagramDriver_old()
    {
        $config = $this->app['config']['services.instagram'];
        return new InstagramProvider(
            $this->app['request'], new InstagramServer($this->formatConfig($config))
        );
    }*/
