		...
		<div class="content-wrapper">
			...
			<section class="content">
				...
				<div class="box-body row">
					<form method="POST" name="wallet_transactions" action="/admin/wallet-op">
						@csrf
						<div class="form-group col-md-6">Transaction Type</div>
						...
						<div class="form-group col-md-6">Message</div>
						...
						<div class="form-group col-md-6">
							...
							<a class="btn btn-default"href="/admin/userwallet">Back</a>
						</div>
