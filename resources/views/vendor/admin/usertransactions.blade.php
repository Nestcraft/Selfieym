		...
		<div class="content-wrapper">
			...
			<section class="content">
				...
				<div class="box-header with-border">
					<h3 class="box-title">User Wallet Details</h3>
				</div>
				<div class="box-body row">

					<div class="form-group col-md-6">User Type</div>
					<div class="form-group col-md-6"><?php if(!empty($user_type) && $user_type[0]->user_type_id == '2'):?><?= 'Influencer'; ?><?php else: ?><?= 'Employer'; ?><?php endif; ?></div>

					<div class="form-group col-md-6">Wallet Balance</div>	
					<div class="form-group col-md-6">Rs <?php if(isset($user_wallet_balance) && !empty($user_wallet_balance[0]->wallet_amount)):?><?= $user_wallet_balance[0]->wallet_amount; ?><?php else: ?><?= '0';?><?php endif; ?></div>	
					<div class="form-group col-md-6">Commission Earned</div>	
					<div class="form-group col-md-6">Rs 0</div>



					<?php if(!empty($user_type) && $user_type[0]->user_type_id == '2'):?>


						<div class="form-group col-md-6">Total Bids</div>	
						<div class="form-group col-md-6"><?php if(isset($user_bids) && !empty($user_bids[0]->no_of_bids)):?><?= $user_bids[0]->no_of_bids; ?><?php else: ?><?= '0';?><?php endif; ?></div>		

						<?php else: ?>


							<div class="form-group col-md-6">Contacts Allowed</div>	
							<div class="form-group col-md-6"><?php if(isset($user_bids) && !empty($user_bids[0]->no_of_bids)):?><?= $user_bids[0]->no_of_bids; ?><?php else: ?><?= '0';?><?php endif; ?></div>		
					...
					<tbody>
						<?php if(count($user_transaction_history) > 0): ?>
							...
							foreach($user_transaction_history as $transaction_history): ?>
								<tr>
									<td><?= $serial_number; ?></td>
									<td><?= 'Rs. '.$transaction_history->amount; ?></td>
