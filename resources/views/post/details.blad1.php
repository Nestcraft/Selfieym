							...
							<div class="row pb-4">
								<div class="items-details-info jobs-details-info col-md-8 col-sm-12 col-xs-12 enable-long-words from-wysiwyg">
									...
									@if (!empty($post->required_influencer))
										<!-- Influencer Required -->
										<h5 class="list-title mt-5"><strong>{{ t('Influencer required') }}</strong></h5>
                                        <div>
										    {!! nl2br(createAutoLink(strCleaner($post->required_influencer))) !!}
                                        </div>
                                        <h5 class="list-title mt-5"><strong>{{ t('Influencer Gender') }}</strong></h5>
                                        <div>
										    {!! nl2br(createAutoLink(strCleaner($post->influencer_gender))) !!}
                                        </div>
                                        <h5 class="list-title mt-5"><strong>{{ t('Influencer Age') }}</strong></h5>
                                        <div>
                                        	@if($post->influencer_age == 'any')
