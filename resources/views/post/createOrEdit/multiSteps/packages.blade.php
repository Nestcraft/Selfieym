                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <form class="form" id="postForm" method="POST" action="{{ url()->current() }}">
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12 text-center mt-4">
                                                ...
                                                @endif
                                                <button id="submitPostForm" class="btn btn-success btn-lg submitPostForm"> Payment with Paypal </button>
                                 ...
                                 <!----payumondy start--->
                                 <div class="forcelefter2">
                                 <div id="payoumoneyDiv" style="display:none;">


<form action = "/payu-money-post-packages" method = "post" name="payuForm">


                                 	<div class="row payment-plugin" id="payuPayment" style="">
    <div class="col-md-10 col-sm-12 box-center center mt-4 mb-0">
        <div class="row">
            
            <div class="col-xl-12 text-center">
                <img class=""  style="padding: 21px;" src="https://selfieym.com/images/images.png" title="Payment with Paypal" width="200px;" height="100"><br>
                <button id="submitPayumoneyForm" type="submit" class="btn btn-success btn-lg submitPostForme"> Payment with Payumoney </button>
            </div>
                ...
                <input name="i_package_id" id="i_package_id" value="" type="hidden"> 
                 <input name="p-id" id="p-id" value="" type="hidden" /> 
                  <input name="p-amount" id="p-amount" value="" type="hidden" /> 
...
@section('after_scripts')
    ...
    <script>
        @if (isset($packages) and isset($paymentMethods) and $packages->count() > 0 and $paymentMethods->count() > 0)
			...
			$(document).ready(function ()
			{
				...
				$('.package-selection').click(function () {
					...
					showAmount(packagePrice, packageCurrencySymbol, packageCurrencyInLeft);
					showpayyoumoney(selectedPackage,packagePrice,packagename);
					showPaymentSubmitButton(currentPackagePrice, packagePrice, currentPaymentActive, paymentMethod);
				});
		...
		function showpayyoumoney(selectedPackage,packagePrice,packagename)
		{
			$('#payoumoneyDiv').show();
			$('#i_package_id').val(selectedPackage);
			$('#p-id').val(packagePrice);
			$('#p-amount').val(packagePrice);

		}
		function submitPayyoumoney()
		{

			var packagePrice=$('#p-amount').val();
			alert(packagePrice);
			$('#payuForm').submit();
			if (packagePrice <= 0) {
			$('#payuForm').submit();
