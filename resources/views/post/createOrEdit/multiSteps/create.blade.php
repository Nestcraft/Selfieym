								...
								<form class="form-horizontal" id="postForm" method="POST" action="{{ url()->current() }}" enctype="multipart/form-data">
									...
									<fieldset>
										...
										*/
										...
										<!-- Influencer required -->
										<div class="form-group row required">
											<label class="col-md-3 col-form-label" for="required_influencer">{{ t('Influencer required') }}<sup>*</sup></label>
											<div class="col-md-8">
												<input id="" type="number" name="required_influencer" placeholder="{{ t('Influencer required') }}" class="form-control" value="{{ old('required_influencer') }}" required>
											</div>
										</div>
										<!-- application_url -->
										...
										<div class="form-group row">
											...
											<div class="col-md-4">
												<select name="influencer_age" id="" class="form-control">
													...
													<option value="less_25">{{ t('Bellow Age of 25') }}</option>
													<option value="less_40">{{ t('Bellow Age of 40') }}</option>
													<option value="less_50">{{ t('Bellow Age of 50') }}</option>
													<option value="great_50">{{ t('Above 50') }}</option>
												</select>	
											</div>
											<div class="col-md-4">
										...
										<div class="form-group row">
											...
											<div class="col-md-4">
												<div class="form-check">
													<input name="instagram_chk" id="" class="form-check-input" value="1" type="checkbox">
										...
										<div class="form-group row">
											...
											<div class="col-md-4">
												<div class="form-check">
													<input name="facebook_chk" id="" class="form-check-input" value="1" type="checkbox">
										...
										<div class="form-group row">
											...
											<div class="col-md-4">
												<div class="form-check">
													<input name="twitter_chk" id="" class="form-check-input" value="1" type="checkbox">
										...
										<div class="form-group row">
											...
											<div class="col-md-4">
												<div class="form-check">
													<input name="youtube_chk" id="" class="form-check-input" value="1" type="checkbox">
										...
										<!-- <div class="form-group row">
											...
											<div class="col-md-4">
												<div class="form-check">
													<input name="tiktok_chk" id="" class="form-check-input" value="1" type="checkbox">
										...
										<div class="form-group row">
											...
											<div class="col-md-4">
												<div class="form-check">
													<input name="web_chk" id="" class="form-check-input" value="1" type="checkbox">
										...
										<div class="form-group row">
											...
											<div class="col-md-4">
												<div class="form-check">
													<input name="quora_chk" id="" class="form-check-input" value="1" type="checkbox">
