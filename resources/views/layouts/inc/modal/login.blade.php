				...
				<div class="modal-body">
					...
					@if (
						...
						<div class="row mb-3 d-flex justify-content-center pl-2 pr-2">
							...
							<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-1 pl-1 pr-1">
								<div class="col-xl-12 col-md-12 col-sm-12 col-xs-12 btn btn-lg btn-success">
									<a href="{{ lurl('login/instagram') }}" class="btn-success" title="{!! strip_tags(t('Login with Instagram')) !!}">
