			...
			<!--	<div class="{{ $colClass3 }}">
							...
							<div class="col-sm-12 col-xs-6 col-xxs-12 no-padding-lg">
								<div class="{!! $footerSocialClass !!}">
									...
									<ul class="list-unstyled list-inline footer-nav social-list-footer social-list-color footer-nav-inline">
										...
										<li>
											<a class="icon-color fb" title="" data-placement="top" data-toggle="tooltip" href="{{ config('settings.social_link.facebook_page_url') }}" target="_blank" data-original-title="Facebook">
										...
										<li>
											<a class="icon-color tw" title="" data-placement="top" data-toggle="tooltip" href="{{ config('settings.social_link.twitter_url') }}" target="_blank" data-original-title="Twitter">
										...
										<li>
											<a class="icon-color pin" title="" data-placement="top" data-toggle="tooltip" href="{{ config('settings.social_link.instagram_url') }}" target="_blank" data-original-title="Instagram">
										...
										<li>
											<a class="icon-color gp" title="" data-placement="top" data-toggle="tooltip" href="{{ config('settings.social_link.google_plus_url') }}" target="_blank" data-original-title="Google+">
										...
										<li>
											<a class="icon-color lin" title="" data-placement="top" data-toggle="tooltip" href="{{ config('settings.social_link.linkedin_url') }}" target="_blank" data-original-title="Linkedin">
										...
										<li>
											<a class="icon-color pin" title="" data-placement="top" data-toggle="tooltip" href="{{ config('settings.social_link.pinterest_url') }}" target="_blank" data-original-title="Pinterest">
												<i class="fab fa-pinterest-p"></i>
											</a>
										</li>
										@endif
									</ul>
									<img src="{{ url('images/payumoney-paypal.png') }}" alt="Selfieym Influencers Payment Partners payumoney & paypal India" Title="Selfieym Influencers Payment Partners payumoney & paypal India">
								</div>
							</div>
							@endif
						</div>
					...
					<div class="col-xl-12">
						...
						<div class="copy-info text-center">
							...
							@else
							{{ t('Powered by') }} <a href="http://www.selfieym.com" title="Selfieym.com">Selfieym Technology</a>.
							@endif
							@endif
						</div>
					</div>
