							...
							<div class="col-md-5 col-xs-4 col-xxs-12">
								<h3 class="no-padding text-center-480 useradmin">
									<a href="">
										...
										<img class="userImg" src="/public/images/profile_images/{{$profile_image}}" alt="user">&nbsp;
										@else
										<img class="userImg" src="https://www.gravatar.com/avatar/27dd9f271a5733f68306f0d248d4dd1f.jpg?s=80&d=https%3A%2F%2Fselfieym.com%2Fimages%2Fuser.jpg&r=g" alt="user">
										@endif
										{{ $user->name }}
									</a>
								</h3>
									...
									<div class="hdata">
										<div class="mcol-left">
											...
											<div class="mcol-right">
												<!-- Number of messages -->
												<p>
													<a href="{{ lurl('account/wallet') }}">
														<?php if(!empty($user_wallet_balance->wallet_amount)):?>Rs. <?= $user_wallet_balance->wallet_amount; ?><?php else:?>Rs. 0<?php endif; ?>
													</a>
												</p>
											</div>
...
<?php if(!empty($user_type_id) && $user_type_id == 1):?>
	<div class="form-group row required">
