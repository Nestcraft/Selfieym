					...
					<div class="form-group row required">
						...
						<div class="form-group row">
							...
							<div class="input-group col-md-5">
								...
								class="form-control{{ $companyFacebookError }}" placeholder="write,copy paste your page link with http"
								value="{{ old('facebook_url', (isset($details->facebook_url) ? $details->facebook_url : '')) }}">
							</div>
						...
						<div class="form-group row">
							...
							<div class="input-group col-md-5">
								...
								value="{{ old('twitter_url', (isset($details->twitter_url) ? $details->twitter_url : '')) }}">
							</div>
							<div class="input-group col-md-2">
								<input id=""
						...
						<div class="form-group row">
							...
							<div class="input-group col-md-5">
								...
								value="{{ old('youtube_url', (isset($details->youtube_url) ? $details->youtube_url : '')) }}" style="height: 50px;padding: .5rem .75rem;font-size: .85rem;color: #464a4c;background-color: #fff;background-image: none;background-clip: padding-box;border: 1px solid rgba(0,0,0,.15);border-radius: .2rem;">
							</div>
							<div class="input-group col-md-2">
								<input id=""
						...
						<div class="form-group row">
							...
							<div class="input-group col-md-5">
								...
								value="{{ old('instagram_url', (isset($details->instagram_url) ? $details->instagram_url : '')) }}">
							</div>
							<div class="input-group col-md-2">
								<input id=""
						...
						<div class="form-group row">
							<label class="col-md-3 col-form-label" for="quora_url">Website/Blog</label>
							<div class="input-group col-md-5">
							
								<input name="quora_url" type="text"
								class="form-control{{ $companyquoraError }}" placeholder=" "
								value="{{ old('quora_url', (isset($details->quora_url) ? $details->quora_url : '')) }}">
							</div>
							<div class="input-group col-md-2">
								<input id=""
