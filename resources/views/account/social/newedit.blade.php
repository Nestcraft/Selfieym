					...
					<div id="accordion" class="panel-group">
						...
						<div class="card card-default">
							<div class="card-header">
								<h4 class="card-title"><a href="#userPanel" data-toggle="collapse" data-parent="#accordion">{{ t('Profile Details') }}New</a></h4>
								<a href="{{ lurl('auth/facebook/callback') }}" class="btn-fb"><i class="icon-facebook-rect"></i> {!! t('Login with Facebook') !!}</a>
							</div>
							<div class="panel-collapse collapse {{ (old('panel')=='' or old('panel')=='userPanel') ? 'show' : '' }}" id="userPanel">
								<div class="card-body">
									...
									<div class="form-group row">
										<label class="col-md-2 col-form-label" for="facebook_url">Instagram </label>
										<div class="input-group col-md-3">

											<a href="{{ lurl('login/instagram') }}" class="btn btn-info">Connect Instagram </a>
										</div>
										<div class="input-group col-md-6">
											<input type="text" value="instagram.com/avikumar91" class="form-control">
										</div>

									</div>
									<div class="form-group row">
										<label class="col-md-2 col-form-label" for="facebook_url">Twitter </label>
										<div class="input-group col-md-3">

											<a href="https://selfieym.com/auth/twitter" id="connectTwitterButton" class="btn btn-info">Connect Twitter </a>
										</div>
										<div class="input-group col-md-6">
											<input type="text" value="" id="twitterUsernameInput" placeholder="Twitter Username"class="form-control">
										</div>

									</div>
									<div class="form-group row">
										<label class="col-md-2 col-form-label" for="facebook_url">Facebook </label>
										<div class="input-group col-md-3">

											<a href="{{ lurl('account/socialprofile/connect/facebook') }}" class="btn btn-info">Connect Facebook </a>
										</div>
										<div class="input-group col-md-6">
											<input type="text" value="instagram.com/avikumar91" class="form-control">
										</div>
									...
									<div class="form-group row">
										<label class="col-md-2 col-form-label" for="facebook_url">Youtube </label>
										<div class="input-group col-md-3">

											<a href="{{ lurl('account/socialprofile/connect/youtube') }}" class="btn btn-info">Connect Youtube </a>
										</div>
										<div class="input-group col-md-6">
											<input type="text" value="instagram.com/avikumar91" class="form-control">
										</div>
...
<script>
	$(document).ready(function() {
		...
		/** CONNECT TWITTER FUNCTIONALITY **/
		$(document).on("click","#connectTwitterButton",function(){

			var twitterInputValue = $("#twitterUsernameInput").val();

			if(twitterInputValue.trim() == "")
			{
				toastr.error("Please enter Twitter Username.");
				return;
			}

			$.ajax({
				url: "<?= URL::to('/account/socialprofile/twitterinformation');?>",
				method: 'POST',
				data : {twitter_username:twitterInputValue},
				cache: false,
				async: false,
...
<script>
	...
	$.ajax({
		url: "<?= URL::to('/');?>/account/socialprofile/save_user_portfolio_image",
		method: 'POST',
		data : data,
		processData: false,
		contentType: false,
...
<script type="text/javascript">
	...
	function showfooollooowww(){
		var twitter_username = '@Palwind86239306';
