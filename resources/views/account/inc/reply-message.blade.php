...
<div class="modal fade" id="replyTo{{ $conversation->id }}" tabindex="-1" role="dialog" aria-labelledby="replyTo{{ $conversation->id }}Label" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form enctype="multipart/form-data" role="form" method="POST" action="{{ lurl('account/conversations/' . $conversation->id . '/reply') }}">
				{!! csrf_field() !!}
				<div class="modal-body enable-long-words">
					...
					<div class="form-group">
						<label for="upload_document" class="control-label">Upload Document <span class="text-count"></span>
