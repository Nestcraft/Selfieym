...
<section class="intro-inner1 jumbotron jumbotron-fluid text-left influencer-intro mt-5">
   <div class="container">
   <div class="row">
    <div class="col">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block" src="/public/images/profile_images/man1.jpg" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block" src="/public/images/profile_images/man2.jpg" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block" src="/public/images/profile_images/man1.jpg" alt="Third slide">
    </div>
  </div>
</div>
    </div>
...
<div class="about-intro" style="background:url(https://selfieym.com/storage/app/page/thumb-816x460-699063cfd2c0f32b9f9d4718b0bf58ec.jpeg) no-repeat center;background-size:cover;">
		<div class="dtable hw100">
			<div class="dtable-cell hw50">
				<div class="container text-left">
					<h1 class="intro-title animated fadeInLeft" style="color: #ffffff;">Find & Hire the best <i><b>Influencer</b></i> for your brand marketing </h1>
                    <h3 class="title-1" style="color:#ffffff;"><strong>Connect with of our amazing influencers from around the world on our secure, flexible and cost-effective platform. Start your next social media marketing campaign with 20,000+ Influencers, Youtubers & Bloggers</strong></h3>
				</div>
			</div>
		</div>
	</div>
...
<table class="table table-bordered">
  ...
  <tbody>
    <tr>
      ...
      <td>Otto</td>
      <td>New Order</td>
      <td><button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropdown</button>
