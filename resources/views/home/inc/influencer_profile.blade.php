...
@endif
 ...
 <?php
//      if (empty($influencer_profile_data[0]->name)):
    if($influencer_details_count==0):
      ?>
 ...
 echo "<a href='/account/socialprofile'><button class='btn btn-fb' style='font-size:10px;''>Create Social Profile</button><a>";
    }?>

        {{--/account/socialprofile/edit--}}
    </div>
  </div>
...
<img src="/public/images/profile_images/<?=$influencer_profile_data[0]->profile_image;?>" alt="<?php if (!empty($influencer_profile_data[0]->name)): ?><?=ucfirst($influencer_profile_data[0]->name);?><?php endif;?> -  <?php if (!empty($influencer_profile_data[0]->catname)): ?><?=$influencer_profile_data[0]->catname;?><?php endif;?> Influencer" title ="<?php if (!empty($influencer_profile_data[0]->name)): ?><?=ucfirst($influencer_profile_data[0]->name);?><?php endif;?> -  <?php if (!empty($influencer_profile_data[0]->catname)): ?><?=$influencer_profile_data[0]->catname;?><?php endif;?> Influencer">
<?php else: ?>
<img src="https://www.gravatar.com/avatar/2fb1121670440f4cd693e7478111d453.jpg?s=80&d=https%3A%2F%2Fselfieym.com%2Fimages%2Fuser.jpg&r=g" alt="Influencer for Social Media Marketing" title ="Influencer for paid Campaign">
...
<td><a href="javascript:void(0);">Update</td>
</tr>
...
<tr>
<td><button type="button" class="btn btn-ins btn" style="font-size:10px; background-color:#0ea634;"> <i class="fab fa-quora"></i></button> Website/Blog</td>
...
<div class="col-5">
<div class="bordered-tab-contents" style="height: 320px;">
...
<?php  endif;?>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <input type="hidden" name="username" id="username" value="{{$instagramDetails->instagram}}">
...
<input type="hidden" name="to_phone" value = "<?php if ($to_phone): ?><?=($to_phone);?><?php else: ?><?='0';?><?php endif;?>">
