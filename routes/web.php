...
Route::group([
	...
	Route::group([
		...
		CRUD::resource('packages_influencer', 'PackageinfluencerController');
		...
		Route::get('userwallet', 'UserController@user_wallet');
		Route::get('commission', 'UserController@commission');

		Route::any('user_withdraw_request', 'UserController@user_withdraw_request');
		Route::any('completed_withdraw_request', 'UserController@completed_withdraw_request');
		
		Route::any('update_user_wallet_transaction_request', 'UserController@update_user_wallet_transaction_request');


		Route::get('usertransactions/{user_id}', 'UserController@usertransactions');

		Route::get('wallet/{user_id}', 'UserController@wallet');

		Route::any('wallet-op', 'UserController@wallet_transaction');
...
// Route::post('payu-money-infuencer-packages', 'HomeController@pay_u_money_influencer_packages');
 Route::get('twitter_callback_user', 'HomeController@twitter_callback_user')->name('twitter_callback_user');
...
Route::group([
	...
	Route::group(['middleware' => ['web','install.checker']], function ($router) {
		...
		/**********NEW ROUTES DEFINED WEBC *********/

		Route::any('paymentsuccess', 'HomeController@payumoney_paymentSuccess')->name('paymentsuccess');

		Route::any('paymentfailure', 'HomeController@payumoney_paymentFailure')->name('paymentfailure');

		Route::any('paymentfailurewallet', 'HomeController@paymentfailurewallet')->name('paymentfailurewallet');

		Route::any('paymentsuccesswallet', 'HomeController@paymentsuccesswallet')->name('paymentsuccesswallet');

		// if package amount is less than 1
		Route::any('buyfreepackage', 'HomeController@buyfreepackage')->name('buyfreepackage');
		// if package amount is less than 1

		Route::any('messageinfluencer', 'HomeController@sendmessage_influencer')->name('messageinfluencer');


		Route::get('influencer-profile/{id}', 'HomeController@viewInfluencerProfile');

		Route::any('influencer-rate-packages', 'HomeController@influencerRatePackages');

		Route::any('reject-rate-request-package-influencer/{conversation_id}', 'HomeController@reject_rate_request_package_influencer');
		Route::any('accept-rate-request-package-influencer/{conversation_id}', 'HomeController@accept_rate_request_package_influencer');

		Route::get('influencer-packages', 'HomeController@influencer_packages');

		Route::get('demo-page', 'HomeController@demo_page');
		Route::get('demo-page1', 'HomeController@demo_page1');

		Route::any('check_influencer_packages', 'HomeController@check_influencer_packages');


		Route::get('employer-packages', 'HomeController@employer_packages');

		Route::post('payu-money-infuencer-packages', 'HomeController@pay_u_money_influencer_packages');

		Route::post('payu-money-employer-packages', 'HomeController@pay_u_money_employer_packages');
		Route::post('payu-money-post-packages', 'HomeController@pay_u_money_post_packages');
		//******myrate package**********/
		Route::post('pay_u_money_myrate','HomeController@pay_u_money_myrate');
		Route::any('payumoney_payment_myrate_Success', 'HomeController@payumoney_payment_myrate_Success')->name('paymentsuccess');
		Route::any('payumoney_payment_myrate_failure', 'HomeController@payumoney_payment_myrate_Success')->name('paymentsuccess');
		//for wallet payment
		Route::post('pay_with_wallet_myrate','HomeController@pay_with_wallet_myrate');
		...
		Route::group(['middleware' => ['guest', 'prevent.back.history']], function ($router) {
			...
			$router->pattern('provider', 'facebook|linkedin|twitter|google|instagram');
			//Route::get('auth/facebook', 'Auth\SocialController@redirectToFacebookProvider');
			Route::get('auth/{provider}', 'Auth\SocialController@redirectToProvider');
			Route::get('auth/{provider}', 'Auth\SocialController@redirectToProvider');
			Route::get('auth/{provider}/callback', 'Auth\SocialController@handleProviderCallback_new');
 ...
 'Auth\LoginController@redirectToInstagramProvider');

Route::get('login/instagram/callback', 'Auth\LoginController@instagramProviderCallback');
		...
		Route::group(['middleware' => ['auth', 'banned.user', 'prevent.back.history'], 'namespace' => 'Account'], function ($router) {
			...
			// Users
			Route::any('account/notifications', 'EditController@notifications');
			Route::get('account', 'EditController@index');

			Route::any('account/wallet', 'EditController@wallet');
			Route::any('account/transaction', 'EditController@transaction');
			Route::any('account/rating_review', 'EditController@rating_review');

			Route::any('account/rating_review_influencer', 'EditController@rating_review_influencer');

			Route::any('account/check_employer_review', 'EditController@check_employer_review');

			Route::any('account/wallettransaction', 'EditController@wallet_trans');
			
			Route::any('account/withdrawrequest', 'EditController@withdrawrequest');

			Route::any('account/userwithdrawrequest', 'EditController@userwithdrawrequest');

			Route::any('account/save_bank_details', 'EditController@save_bank_details');
			
			Route::any('account/save_paypal_details', 'EditController@save_paypal_details');

			Route::any('account/awardedprojects', 'EditController@awardedprojects');
			Route::any('account/recievedprojects', 'EditController@recievedprojects');

			Route::any('account/completeproject', 'EditController@complete_project');

			Route::any('account/releasepayment', 'EditController@releasepayment_employer');
			Route::any('account/releasepaymentpackage', 'EditController@releasepayment_package_employer');
			...
			//social profile
			Route::get('account/socialprofile', 'SocialProfileController@index');
			Route::get('account/socialprofile/edit', 'SocialProfileController@edit');
			Route::get('account/socialprofile/new', 'SocialProfileController@new');
			Route::post('account/socialprofile/twitterinformation', 'SocialProfileController@twitterinformation');
			Route::get('account/socialprofile/myrate', 'SocialProfileController@myrate');
			Route::post('account/socialprofile/myrateupdate', 'SocialProfileController@myrateupdate');
			Route::post('account/socialprofile/myratestandardupdate', 'SocialProfileController@myratestandardupdate');
			Route::post('account/socialprofile/myratepremiumupdate', 'SocialProfileController@myratepremiumupdate');
			Route::post('account/socialprofile/create', 'SocialProfileController@create');
			//WEBC
			Route::post('account/socialprofile/save_youtube_url', 'SocialProfileController@save_youtube_url');
			Route::post('account/socialprofile/save_user_portfolio', 'SocialProfileController@save_user_portfolio');
			
			Route::post('account/socialprofile/save_user_portfolio_image', 'SocialProfileController@save_user_portfolio_image');

			Route::post('account/socialprofile/remove_portfolio', 'SocialProfileController@remove_portfolio');

			Route::post('account/socialprofile/remove_youtube_url', 'SocialProfileController@remove_youtube_url');

			Route::any('account/socialprofile/portfolio', 'SocialProfileController@portfolio');
			Route::match(['get', 'post'],'account/socialprofile/instagram', 'SocialProfileController@instagram');
			Route::get('account/socialprofile/connect/{provider}', 'SocialProfileController@redirectToProvider');
			Route::get('facebook', 'SocialProfileController@get_facebook_info');
				
				Route::get('account/socialprofile/redirectToInstagramProvider', 'SocialProfileController@redirectToInstagramProvider');
				Route::get('account/socialprofile/callback', 'SocialProfileController@instagramProviderCallback');
			...
			Route::get('account/twitter_callback_user', 'ResumeController@twitter_callback_user');
			...
			// project award 
			Route::any('account/awardproject', 'ConversationsController@award_project');
			Route::post('account/conversation/milestoneget', 'ConversationsController@milestoneget');
...
Route::group(['prefix' => 'ajax'], function ($router) {
	...
	Route::post('messages/notification', 'Ajax\ConversationController@checkNotification');
});
...
Route::get(LaravelLocalization::transRoute('routes.i-search'), 'Search\InfluencersController@index');
...
Route::get(LaravelLocalization::transRoute('routes.influencers-cat'), 'Search\InfluencerscategoryController@index');
Route::get(LaravelLocalization::transRoute('routes.search-cat'), 'Search\CategoryController@index');
Route::get(LaravelLocalization::transRoute('routes.influencers-subCat'), 'Search\InfluencerscategoryController@index');
Route::get(LaravelLocalization::transRoute('routes.influencers-search-cat'), 'Search\InfluencerscategoryController@index');
});
});
