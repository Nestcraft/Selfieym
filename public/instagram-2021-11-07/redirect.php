...
if(isset($_GET['op']) && $_GET['op']=="getauth") {
	...
	//echo sprintf($urlconfig['authorization_url'],$appconfig['client_id'],$appconfig['redirect_url'],$appconfig['scope']);exit;
	
	header("Location: ".sprintf($urlconfig['authorization_url'],$appconfig['client_id'],$appconfig['redirect_url'],$appconfig['scope']));
	exit;
